...
class PythonIntro(object):
    ...
    def sequences(self, seq_start=3, seq_end=7, seq_step=1):
        ...
        # Dazu verwenden wir eine etwas laengere Liste. Mit list(range()) kann
        # eine fortlaufende Liste von int Objekten erzeugt werden.
    ...
    def sequences_complex(self, test_seq=(1, 1.0, '1.0')):
        ...
        # https://docs.python.org/3/library/functions.html (Gehe zu type() sowie str() )
        #
        ...
        # Alternativ können strings auch mit der format() funktion formatiert werden
...
def intro():
    ...
    #
    print('Willkommen bei der Uebung zur Vorlesung Mustererkennung!')
    #
